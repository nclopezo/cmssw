...
public:
    ...
    /// get / set board type
    inline const L1GtBoardType gtBoardType() const
    {
    ...
    /// get / set board index
    inline const int gtBoardIndex() const
    {
    ...
    inline const int gtPositionDaqRecord() const
    {
    ...
    inline const int gtPositionEvmRecord() const
    {
    ...
    inline const int gtBitDaqActiveBoards() const
    {
    ...
    inline const int gtBitEvmActiveBoards() const
    {
    ...
    inline const int gtBoardHexName() const
    {
