...
public:
  ...
  void setEtaPhiThreshold_barrel(const double EtaPhiThreshold_barrel) {m_EtaPhiThreshold_barrel = EtaPhiThreshold_barrel;}
  ...
  void setEtaPhiThreshold_endcap(const double EtaPhiThreshold_endcap) {m_EtaPhiThreshold_endcap = EtaPhiThreshold_endcap;}
  ...
  void setHaloOverwritesMatchedFwd(const bool HaloOverwritesMatchedFwd) {m_HaloOverwritesMatchedFwd = HaloOverwritesMatchedFwd;}
